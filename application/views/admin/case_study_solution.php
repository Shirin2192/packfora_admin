                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <table id="CaseSṭudySolutionTable" class="display">
                                        <thead>
                                            <tr>
                                                <th>Sr. No.</th>
                                                <th>Image</th>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="ViewModalLabel">View Case Study Solution</h5>
                ...
                <div class="modal-body" id="modalBodyContent">
                    <div class="row mb-3">
                        <div class="col-md-12">
                            <label for="view_main_title"><strong>Main Title</strong></label>
                            <p id="view_main_title" class="mb-2"></p>
                        </div>
                        <div class="col-md-12">
                            <label for="view_main_description"><strong>Main Description</strong></label>
                            <p id="view_main_description" class="mb-2"></p>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p id="view_title" class="mb-2"></p>
                        </div>
                        <div class="col-md-6">
                            <label for="view_description"><strong>Description</strong></label>
                            <p id="view_description" class="mb-2"></p>
                        </div>
                        <div class="col-md-6">
                            <label for="view_image"><strong>Image</strong></label>
                            <div id="view_image" class="mb-2"></div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal fade" id="EditModal" tabindex="-1" aria-labelledby="EditModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <form id="EditCaseStudySolutionForm" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <label for="edit_main_title">Main Title</label>
                                <input type="text" class="form-control" name="edit_main_title" id="edit_main_title">
                                <div class="text-danger" id="error_edit_main_title"></div>
                            </div>
                            <div class="col-md-12 mt-2">
                                <label for="edit_main_description">Main Description</label>
                                <textarea class="form-control" name="edit_main_description" id="edit_main_description" rows="3"></textarea>

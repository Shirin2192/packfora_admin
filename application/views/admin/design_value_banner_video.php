...
<body>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <form id="DesignValueVideoBannerForm" class="forms-sample"
                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <table id="DesignValueVideoBannerTable" class="display">
                                        <thead>
                                            <tr>
                                                <th>Sr. No.</th>
                                                <th>Title</th>
        ...
        <div class="modal fade" id="EditModal" tabindex="-1" aria-labelledby="EditModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form id="EditDesignValueVideoBannerForm" enctype="multipart/form-data">
                        <div class="modal-body" id="modalBodyContent">
    ...
    <script src="<?= base_url()?>assets/view_js/design_value_video_banner.js"></script>
</body>

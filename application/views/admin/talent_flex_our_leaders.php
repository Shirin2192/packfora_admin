...
<body>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <form id="TalentFlexOurLeadersForm" class="forms-sample"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="TalentFlexOurLeadersTable" class="display">
                                            <thead>
                                                <tr>
                                                    <th>Sr. No.</th>
                                                    <th>Name</th>
        ...
        <div class="modal fade" id="EditModal" tabindex="-1" aria-labelledby="EditModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form id="EditTalentFlexOurLeadersForm" enctype="multipart/form-data">
                        <div class="modal-body" id="modalBodyContent">
    ...
    <script src="<?= base_url()?>assets/view_js/talent_flex_our_leaders.js"></script>

...
<body>
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title">Featured Speakers </h3>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Featured Speakers</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <form id="FeaturedSpeakerForm" class="forms-sample" enctype="multipart/form-data">
                                        <div class="row">
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="quote_text" id="quote_text"
                                                        placeholder="Image Name">
                                                    <div class="text-danger" id="error_quote_text"></div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                        ...
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <table id="FeaturedSpeakerTable" class="display">
                                        <thead>
                                            <tr>
                                                <th>Sr. No.</th>
                                                <th>Name</th>                                                
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" id="modalBodyContent">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <label for="view_quote_text">Quote Text</label>
                                <p id="view_quote_text"></p>
                            </div>
                            <div class="col-md-6">
        ...
        <div class="modal fade" id="EditModal" tabindex="-1" aria-labelledby="EditModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form id="EditFeaturedSpeakerForm" enctype="multipart/form-data">
                        <div class="modal-body" id="modalBodyContent">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="edit_quote_text" name="edit_quote_text">
                                    <div class="text-danger" id="error_edit_quote_text"></div>
                                </div>
    ...
    <script src="<?= base_url()?>assets/view_js/featured_speakers.js"></script>

...
<body>
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title">Discover the Benefits of Talent Flex </h3>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Discover the Benefits of Talent Flex</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="row">
    ...
    <script src="<?= base_url()?>assets/view_js/benefits_of_talent_flex.js"></script>

...
<body>
            ...
            <div class="main-panel">
                <div class="content-wrapper">
                    <div class="page-header">
                        <h3 class="page-title">Talent Flex Success Stories</h3>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">Dashboard</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Talent Flex Success Stories</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <form id="TalentFlexSuccessStoriesForm" class="forms-sample"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="TalentFlexSuccessStoriesTable" class="display">
                                            <thead>
                                                <tr>
                                                    <th>Sr. No.</th>
                                                    <th>Title</th>
        ...
        <div class="modal fade" id="EditModal" tabindex="-1" aria-labelledby="EditModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form id="EditTalentFlexSuccessStoriesForm" enctype="multipart/form-data">
                        <div class="modal-body" id="modalBodyContent">
    ...
    <script src="<?= base_url()?>assets/view_js/talent_flex_success_stories.js"></script>

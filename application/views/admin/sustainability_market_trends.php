...
<body>
                ...
                <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <form id="SustainabilityMarketTrendsForm" class="forms-sample">
                                        <div class="row">
                                            <div class="col-md-6">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table id="SustainabilityMarketTrendsTable" class="display nowrap" style="width:100%">
                                            <thead>
                                                <tr>
                                                    <th>Sr. No.</th>
                                                    <th>Title</th>
        ...
        <div class="modal fade" id="EditModal" tabindex="-1" aria-labelledby="EditModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <form id="EditSustainabilityMarketTrendsForm">
                        <div class="modal-body" id="modalBodyContent">
    ...
    <script src="<?= base_url()?>assets/view_js/sustainability_market_trends.js"></script>

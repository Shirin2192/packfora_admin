$(document).ready(function () {
    $('#DiscovertheBenefitsofDesignValueForm').on('submit', function (e) {
        e.preventDefault();
        ...
        $.ajax({
            url: frontend + "admin/save_benefits_of_design_value",  // Adjust URL accordingly
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
            ...
            success: function (response) {
                if (response.status === 'success') {
                    ...
                    $('#DiscovertheBenefitsofDesignValueForm')[0].reset();
                     // Reload the DataTable
                    DiscovertheBenefitsofDesignValueTable.ajax.reload(null, false);
...
$(document).ready(function () {
    ...
    DiscovertheBenefitsofDesignValueTable = $('#DiscovertheBenefitsofDesignValueTable').DataTable({
        ajax: {
            url: frontend + "admin/get_benefits_of_design_value_data",  // Adjust URL accordingly
            type: 'POST',
    ...
    $("#DiscovertheBenefitsofDesignValueTable").on("click", ".view-btn", function (e) {
        e.preventDefault();
        const id = $(this).data("id");

        $.ajax({
            url: frontend + "admin/get_benefits_of_design_value_details",
            type: "POST",
            dataType: "json",
    ...
    $("#DiscovertheBenefitsofDesignValueTable").on("click", ".edit-btn", function (e) {
        e.preventDefault();
        const id = $(this).data("id");
    ...
    // Delete action
	$("#DiscovertheBenefitsofDesignValueTable").on("click", ".delete-btn", function (e) {
		e.preventDefault();
		const id = $(this).data("id");
		...
		Swal.fire({
			...
			if (result.isConfirmed) {
				$.ajax({
					url: frontend + "admin/delete_benefits_of_design_value",
					type: "POST",
					data: { id: id },
					dataType: "json",
					success: function (response) {
...
$('#EditDiscovertheBenefitsofDesignValueForm').submit(function (e) {
    e.preventDefault();
    ...
    $.ajax({
        url: frontend + "admin/update_benefits_of_design_value", // adjust to your route
        type: "POST",
        data: formData,
        dataType: "json",
        contentType: false,
        ...
        success: function (response) {
            if (response.status === 'success') {
                ...
                // Reset the form
                $('#EditDiscovertheBenefitsofDesignValueForm')[0].reset();

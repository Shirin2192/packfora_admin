$(document).ready(function () {
    $('#VideoBannerForm').on('submit', function (e) {
        ...
        $.ajax({
            url: frontend + "admin/save_video_banner",  // Adjust URL accordingly
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
...
$(document).ready(function () {
    ...
    VideoBannerTable = $('#VideoBannerTable').DataTable({
        ajax: {
            url: frontend + "admin/get_video_banner_data",  // Adjust URL accordingly
            type: 'POST',
    ...
    $("#VideoBannerTable").on("click", ".view-btn", function (e) {
        ...
        $.ajax({
            url: frontend + "admin/get_video_banner_details",
            type: "POST",
            dataType: "json",
	...
	$("#VideoBannerTable").on("click", ".delete-btn", function (e) {
		...
		Swal.fire({
			...
			if (result.isConfirmed) {
				$.ajax({
					url: frontend + "admin/delete_video_banner",
					type: "POST",
					data: { id: id },
					dataType: "json",
					success: function (response) {
...
$('#EditVideoBannerForm').submit(function (e) {
    ...
    $.ajax({
        url: frontend + "admin/update_video_banner", // adjust to your route
        type: "POST",
        data: formData,
        dataType: "json",
        contentType: false,

$(document).ready(function () {
    $('#DiscovertheBenefitsofSpecificationManagementForm').on('submit', function (e) {
        e.preventDefault();
        ...
        $.ajax({
            url: frontend + "admin/save_benefits_of_specification_management",  // Adjust URL accordingly
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
            ...
            success: function (response) {
                if (response.status === 'success') {
                    ...
                    $('#DiscovertheBenefitsofSpecificationManagementForm')[0].reset();
                     // Reload the DataTable
                    DiscovertheBenefitsofSpecificationManagementTable.ajax.reload(null, false);
...
$(document).ready(function () {
    ...
    DiscovertheBenefitsofSpecificationManagementTable = $('#DiscovertheBenefitsofSpecificationManagementTable').DataTable({
        ajax: {
            url: frontend + "admin/get_benefits_of_specification_management_data",  // Adjust URL accordingly
            type: 'POST',
    ...
    $("#DiscovertheBenefitsofSpecificationManagementTable").on("click", ".view-btn", function (e) {
        e.preventDefault();
        const id = $(this).data("id");

        $.ajax({
            url: frontend + "admin/get_benefits_of_specification_management_details",
            type: "POST",
            dataType: "json",
    ...
    $("#DiscovertheBenefitsofSpecificationManagementTable").on("click", ".edit-btn", function (e) {
        e.preventDefault();
        const id = $(this).data("id");
    ...
    // Delete action
	$("#DiscovertheBenefitsofSpecificationManagementTable").on("click", ".delete-btn", function (e) {
		e.preventDefault();
		const id = $(this).data("id");
		...
		Swal.fire({
			...
			if (result.isConfirmed) {
				$.ajax({
					url: frontend + "admin/delete_benefits_of_specification_management",
					type: "POST",
					data: { id: id },
					dataType: "json",
					success: function (response) {
...
$('#EditDiscovertheBenefitsofSpecificationManagementForm').submit(function (e) {
    e.preventDefault();
    ...
    $.ajax({
        url: frontend + "admin/update_benefits_of_specification_management", // adjust to your route
        type: "POST",
        data: formData,
        dataType: "json",
        contentType: false,
        ...
        success: function (response) {
            if (response.status === 'success') {
                ...
                // Reset the form
                $('#EditDiscovertheBenefitsofSpecificationManagementForm')[0].reset();

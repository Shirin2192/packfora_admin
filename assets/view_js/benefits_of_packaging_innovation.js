$(document).ready(function () {
    $('#DiscovertheBenefitsofPackagingInnovationForm').on('submit', function (e) {
        e.preventDefault();
        ...
        $.ajax({
            url: frontend + "admin/save_benefits_of_packaging_innovation",  // Adjust URL accordingly
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
            ...
            success: function (response) {
                if (response.status === 'success') {
                    ...
                    $('#DiscovertheBenefitsofPackagingInnovationForm')[0].reset();
                     // Reload the DataTable
                    DiscovertheBenefitsofPackagingInnovationTable.ajax.reload(null, false);
...
$(document).ready(function () {
    ...
    DiscovertheBenefitsofPackagingInnovationTable = $('#DiscovertheBenefitsofPackagingInnovationTable').DataTable({
        ajax: {
            url: frontend + "admin/get_benefits_of_packaging_innovation_data",  // Adjust URL accordingly
            type: 'POST',
    ...
    $("#DiscovertheBenefitsofPackagingInnovationTable").on("click", ".view-btn", function (e) {
        e.preventDefault();
        const id = $(this).data("id");

        $.ajax({
            url: frontend + "admin/get_benefits_of_packaging_innovation_details",
            type: "POST",
            dataType: "json",
    ...
    $("#DiscovertheBenefitsofPackagingInnovationTable").on("click", ".edit-btn", function (e) {
        e.preventDefault();
        const id = $(this).data("id");
    ...
    // Delete action
	$("#DiscovertheBenefitsofPackagingInnovationTable").on("click", ".delete-btn", function (e) {
		e.preventDefault();
		const id = $(this).data("id");
		...
		Swal.fire({
			...
			if (result.isConfirmed) {
				$.ajax({
					url: frontend + "admin/delete_benefits_of_packaging_innovation",
					type: "POST",
					data: { id: id },
					dataType: "json",
					success: function (response) {
...
$('#EditDiscovertheBenefitsofPackagingInnovationForm').submit(function (e) {
    e.preventDefault();
    ...
    $.ajax({
        url: frontend + "admin/update_benefits_of_packaging_innovation", // adjust to your route
        type: "POST",
        data: formData,
        dataType: "json",
        contentType: false,
        ...
        success: function (response) {
            if (response.status === 'success') {
                ...
                // Reset the form
                $('#EditDiscovertheBenefitsofPackagingInnovationForm')[0].reset();

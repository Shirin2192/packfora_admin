$(document).ready(function () {
    $('#DiscovertheBenefitsofPackagingProcurementForm').on('submit', function (e) {
        e.preventDefault();
        ...
        $.ajax({
            url: frontend + "admin/save_benefits_of_packaging_procurement",  // Adjust URL accordingly
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
            ...
            success: function (response) {
                if (response.status === 'success') {
                    ...
                    $('#DiscovertheBenefitsofPackagingProcurementForm')[0].reset();
                     // Reload the DataTable
                    DiscovertheBenefitsofPackagingProcurementTable.ajax.reload(null, false);
...
$(document).ready(function () {
    ...
    DiscovertheBenefitsofPackagingProcurementTable = $('#DiscovertheBenefitsofPackagingProcurementTable').DataTable({
        ajax: {
            url: frontend + "admin/get_benefits_of_packaging_procurement_data",  // Adjust URL accordingly
            type: 'POST',
    ...
    $("#DiscovertheBenefitsofPackagingProcurementTable").on("click", ".view-btn", function (e) {
        e.preventDefault();
        const id = $(this).data("id");

        $.ajax({
            url: frontend + "admin/get_benefits_of_packaging_procurement_details",
            type: "POST",
            dataType: "json",
    ...
    $("#DiscovertheBenefitsofPackagingProcurementTable").on("click", ".edit-btn", function (e) {
        e.preventDefault();
        const id = $(this).data("id");
    ...
    // Delete action
	$("#DiscovertheBenefitsofPackagingProcurementTable").on("click", ".delete-btn", function (e) {
		e.preventDefault();
		const id = $(this).data("id");
		...
		Swal.fire({
			...
			if (result.isConfirmed) {
				$.ajax({
					url: frontend + "admin/delete_benefits_of_packaging_procurement",
					type: "POST",
					data: { id: id },
					dataType: "json",
					success: function (response) {
...
$('#EditDiscovertheBenefitsofPackagingProcurementForm').submit(function (e) {
    e.preventDefault();
    ...
    $.ajax({
        url: frontend + "admin/update_benefits_of_packaging_procurement", // adjust to your route
        type: "POST",
        data: formData,
        dataType: "json",
        contentType: false,
        ...
        success: function (response) {
            if (response.status === 'success') {
                ...
                // Reset the form
                $('#EditDiscovertheBenefitsofPackagingProcurementForm')[0].reset();
